...
# BR2_PACKAGE_AESD_ASSIGNMENTS_NOPIVOT_CONTAINERD
AESD_ASSIGNMENTS_NOPIVOT_CONTAINERD_VERSION = 1.0
AESD_ASSIGNMENTS_NOPIVOT_CONTAINERD_SITE = $(AESD_ASSIGNMENTS_NOPIVOT_CONTAINERD_PKGDIR)/src
AESD_ASSIGNMENTS_NOPIVOT_CONTAINERD_SITE_METHOD = local
AESD_ASSIGNMENTS_NOPIVOT_CONTAINERD_LICENSE = GPL-2.0+

define AESD_ASSIGNMENTS_NOPIVOT_CONTAINERD_BUILD_CMDS
	$(MAKE) $(TARGET_CONFIGURE_OPTS) -C $(@D)
endef

define AESD_ASSIGNMENTS_NOPIVOT_CONTAINERD_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0755 $(@D)/nopivotcontainerd $(TARGET_DIR)/usr/bin/nopivotcontainerd
endef
